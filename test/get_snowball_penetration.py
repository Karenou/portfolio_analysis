...
Usage:
  ...
  python -m test.test_snowball_penetration                        # shallow mode (fast)
  python -m test.test_snowball_penetration --deep --file snowball_20260227.pdf               # deep mode (full stock-level)
  python -m test.test_snowball_penetration --date 20251231 --file snowball_20260227.pdf      # specify holdings date
  python -m test.test_snowball_penetration --deep --date 20251231 --file snowball_20260227.pdf # deep + date
"""
