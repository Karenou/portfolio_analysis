...
Usage:
  ...
  python -m script.get_alipay_penetration                        # shallow mode (fast)
  python -m script.get_alipay_penetration --deep --file alipay_20260225.pdf               # deep mode (full stock-level)
  python -m script.get_alipay_penetration --date 20251231 --file alipay_20260225.pdf      # specify holdings date
  python -m script.get_alipay_penetration --deep --date 20251231 --file alipay_20260225.pdf # deep + date
"""
...
if __name__ == "__main__":
    ...
    if args.fetch_nav:
        logger.info("Starting fund NAV fetch for alipay...")
        from analyzers.fund_nav_db import fetch_and_store_fund_nav
        fetch_and_store_fund_nav("alipay")
