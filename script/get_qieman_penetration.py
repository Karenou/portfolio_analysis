...
Usage:
  ...
  python -m script.get_qieman_penetration                        # shallow mode (fast)
  python -m script.get_qieman_penetration --deep --file qieman_20260224.pdf               # deep mode (full stock-level)
  python -m script.get_qieman_penetration --date 20251231 --file qieman_20260224.pdf      # specify holdings date
  python -m script.get_qieman_penetration --deep --date 20251231 --file qieman_20260224.pdf # deep + date
"""
...
if __name__ == "__main__":
    ...
    if args.fetch_nav:
        logger.info("Starting fund NAV fetch for qieman...")
        from analyzers.fund_nav_db import fetch_and_store_fund_nav
        fetch_and_store_fund_nav("qieman")
