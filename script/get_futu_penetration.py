...
Usage:
  ...
  python -m script.get_futu_penetration                        # default file
  python -m script.get_futu_penetration --file futu_20260206.pdf  # specify file
"""
...
ap.add_argument("--file", type=str, required=True, help="PDF file name (default: futu_20260206.pdf)")
