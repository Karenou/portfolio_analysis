...
测试 analyzers/indicators.py 的各项功能：
- 时间窗口解析
- 单资产指标计算
- Portfolio 整体指标计算
- 相关性矩阵
...
运行方式：
    ...
    python -m script.test_indicators
"""
...
def test_compute_all():
    """测试全量计算入口。"""
    print("\n" + "=" * 60)
    print("测试 6: compute_all_indicators() 全量计算")
    print("=" * 60)
